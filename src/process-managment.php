...
<!-- Основной контент -->
<main>
  <section id="process" class="process-managment">
    <div class="container">
      <div class="process__heading process-heading process-heading--underline">
        <div class="row">
          <div class="col-12 col-lg-6">
            <h2 class="process-heading__title section__title">Управление проектами</h2>
          </div>
          <!-- /.col-12 col-lg-6 -->

          <div class="col-12 col-lg-6">
            <p class="process-heading__text section__text">Мы всегда будем активно управлять вашим проектом. Будем под рукой, чтобы помочь вам на каждом шагу и быстро решить проблемы, когда они возникают. Все, что мы делаем, ориентировано на вас и ваши потребности.</p>
          </div>
          <!-- /.col-12 col-lg-6 -->
        </div>
        <!-- /.row -->
