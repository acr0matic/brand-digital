  ...
  <div class="container">
    <div class="footer">
      <div class="footer__info">
        ...
        <span class="footer__year">2021 г.</span>
      </div>
      <!-- /.footer__info -->
      ...
      <div class="footer__contact">
        <a href="" class="footer__link footer__link--main link link--main link--orange">Контакты</a>
        <a href="mailto:" class="footer__link link link--orange">info@branddigital.ru</a>
      ...
      <div class="footer__office">
        <a href="contact.php#map" class="footer__link footer__link--main link link--main link--orange">Офисы и боксы</a>
        <a href="contact.php#map" class="footer__link link link--orange">г. Нижний Новгород</a>
        <a href="contact.php#map" class="footer__link link link--orange">г. Москва</a>
        <a href="contact.php#map" class="footer__link link link--orange">г. Казань</a>

        <span class="footer__additional">Работаем по всей России!</span>
      </div>
      <!-- /.footer__contact -->

      <img id="scrollTop" src="img/icons/misc/scroll-up.svg" alt="" class="footer__up">
      <!-- /.footer__up -->
    </div>
    <!-- /.footer -->
